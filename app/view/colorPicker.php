...
jQuery("canvas#pixMap").click(function(e) {
	var clr = document.color.imagePicker.getRGBPixel(
		Math.round(e.pageX - $(this).offset().left),
		Math.round(e.pageY - $(this).offset().top)
	);
...
jQuery("canvas#picker").click(function(e) {
	...
	var clr = document.color.imageGradient.getRGBPixel(
		Math.round(e.pageX - $(this).offset().left),
		Math.round(e.pageY - $(this).offset().top)
	);
	console.log(clr);
